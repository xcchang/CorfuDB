...
public class AbstractObjectTest extends AbstractViewTest {
     ...
     */
    protected <T extends ISMRObject> T instantiateCorfuObject(
    ...
    protected <T extends ISMRObject> T instantiateCorfuObject(Class<T> tClass, String name) {
     ...
     * @return an object instance of type T backed by a stream named 'name'
     */
    protected <T extends ISMRObject> Object instantiateCorfuObject(
    ...
    protected <T extends ISMRObject> Object instantiateCorfuObject(TypeToken<T> tType, String name) {
