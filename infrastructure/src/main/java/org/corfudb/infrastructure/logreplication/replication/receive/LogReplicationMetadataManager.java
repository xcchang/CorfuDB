...
public class LogReplicationMetadataManager {
    ...
    public long getLastAppliedSnapshotTimestamp() {
        return query(null, LogReplicationMetadataType.LAST_BASE_SNAPSHOT_APPLIED);
    }

    private long getLastSnapshotAppliedSequenceNumber() {
        return query(null, LogReplicationMetadataType.LAST_SNAPSHOT_APPLIED_SEQUENCE_NUMBER);
    }
    ...
    public boolean setBaseSnapshotStart(long topologyConfigId, long ts) {
        ...
        appendUpdate(txBuilder, LogReplicationMetadataType.LAST_BASE_SNAPSHOT_APPLIED, Address.NON_ADDRESS);
    ...
    public void setSnapshotAppliedComplete(LogReplicationEntry entry) {
        ...
        // Update the topologyConfigId to fence all other transactions that update the metadata at the same time
        appendUpdate(txBuilder, LogReplicationMetadataType.TOPOLOGY_CONFIG_ID, topologyConfigId);
        appendUpdate(txBuilder, LogReplicationMetadataType.LAST_BASE_SNAPSHOT_APPLIED, ts);
        ...
        for (LogReplicationMetadataType type : LogReplicationMetadataType.values()) {
            ...
            switch (type) {
                ...
                case LAST_SNAPSHOT_TRANSFERRED:
                   ...
                   break;
                case LAST_BASE_SNAPSHOT_APPLIED:
                ...
                case LAST_LOG_ENTRY_PROCESSED:
                   ...
                   break;
                case LAST_SNAPSHOT_APPLIED_SEQUENCE_NUMBER:
                    builder.append(getLastSnapshotAppliedSequenceNumber());
                    break;
                default:
                    // error
            }
    ...
    public enum LogReplicationMetadataType {
        ...
        LAST_BASE_SNAPSHOT_APPLIED("lastBaseSnapshotApplied"),
        LAST_SNAPSHOT_APPLIED_SEQUENCE_NUMBER("lastSnapshotAppliedSeqNumber"),
