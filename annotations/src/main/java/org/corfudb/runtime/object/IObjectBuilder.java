 ...
 */
public interface IObjectBuilder<T extends ISMRObject<T>> {
     ...
     */
    <R extends ISMRObject<R>> IObjectBuilder<R> setTypeToken(
     ...
     * @return  A typed version of this object builder, to support chaining.
     */
    <R extends ISMRObject<R>> IObjectBuilder<R> setType(Class<R> type);
