...
//        DefaultClusterManager siteManagerA = (DefaultClusterManager) serverA.getSiteManagerAdapter();
//        DefaultClusterManager siteManagerB = (DefaultClusterManager) serverB.getSiteManagerAdapter();
//
...
//                " mapA size " + mapA.size() + " tail " + activeRuntime.getAddressSpaceView().getLogTail());
    ...
    private static void waitForReplication(IntPredicate verifier, CorfuTable table) {
