...
public class OptimisticTransactionalContext extends AbstractTransactionalContext {
     ...
     */
    @Override
    public <R, T extends ISMRObject<T>> R access(ICorfuSMRProxyInternal<T> proxy,
     ...
     */
    @Override
    public <T extends ISMRObject<T>> Object getUpcallResult(ICorfuSMRProxyInternal<T> proxy,
     ...
     */
    @Override
    public <T extends ISMRObject<T>>long logUpdate(ICorfuSMRProxyInternal<T> proxy,
