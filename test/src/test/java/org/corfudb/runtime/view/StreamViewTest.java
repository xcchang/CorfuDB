...
public class StreamViewTest extends AbstractViewTest {
    ...
    public void testCompactionMark() {
        ...
        final int entryNum = getServerContext(SERVERS.PORT_0).getStreamLogParams().recordsPerSegment + 1;
        ...
        sv.seek(0L);
        sv.next();
        SMRLogEntry logEntry = (SMRLogEntry) sv.next().getPayload(r);
