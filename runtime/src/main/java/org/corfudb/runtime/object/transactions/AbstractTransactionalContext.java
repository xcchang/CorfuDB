...
public abstract class AbstractTransactionalContext implements
     ...
     */
    public abstract <R, T extends ISMRObject<T>> R access(ICorfuSMRProxyInternal<T> proxy,
     ...
     */
    public abstract <T extends ISMRObject<T>> Object getUpcallResult(ICorfuSMRProxyInternal<T> proxy,
                                                                     long timestamp,
                                                                     Object[] conflictObject);
     ...
     */
    public abstract <T extends ISMRObject<T>> long logUpdate(ICorfuSMRProxyInternal<T> proxy,
